              ...
              <div class="col-md-3 col-sm-6">
                ...
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="fa-solid fa-user-plus""></i></div><strong>Create User</strong>
                    </div>
         ...
         aria-valuenow="{{ $mappedPercentage }}" aria-valuemin="0" aria-valuemax="100"
              ...
              <div class="col-md-3 col-sm-6">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-writing-whiteboard"></i></div><strong>Collection Report</strong>
                    </div>
