        ...
        <form id="dailyCollectionForm" method="POST" action="{{ route('daily.collection.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="date" name="date" id="date" class="form-control" required
                    value="{{ $today }}" max="{{ \Carbon\Carbon::today()->format('Y-m-d') }}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" name="online_collection" id="onlineCollection" class="form-control"
                    required>
            </div>

            <div class="mb-3">
                <label class="form-label">Offline Collection</label>
                <input type="number" step="0.01" name="offline_collection" id="offlineCollection" class="form-control"
                    required>
            </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            shopSelect.addEventListener('change', function() {
                ...
                if (collection) {
                    ...
                    messageDiv.textContent =
                        `Data already entered today as on ${formattedDate} at ${formattedTime}. Again saving will update it.`;
                    ...
                    totalInput.value = (parseFloat(collection.online_collection) + parseFloat(collection
                        .offline_collection)).toFixed(2);
